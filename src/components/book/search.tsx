...
// export default function SearchBook({ handleSearch }: Props) {
//     const [searchValue, setSearchValue] = useState<SearchBookValue[]>([]);
...
//         const newValue: SearchBookValue = { value, hashtag };
